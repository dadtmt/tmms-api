...
describe('getCurrentCrossroadStep', function () {
  it('return 1 if no crossroads', function () {
    var data = {};
    expect((0, _editor.getCurrentCrossroadStep)(data)).toBe(1);
  });

  it('return current step', function () {
    var data = {
      viewer: {
        user: {
          editors: {
    ...
    expect((0, _editor.getCurrentCrossroadStep)(data)).toBe(2);
  });
});
