...
exports.updateCrossroad = exports.updateEditor = exports.getCurrentCrossroadStep = exports.getCurrentCrossroadId = exports.splitCrossroads = exports.setCurrentCrossroad = exports.getCrossroadsEdges = undefined;
...
var getCurrentCrossroad = _ramda2.default.pipe(splitCrossroads, _ramda2.default.prop('current'));

var getCurrentCrossroadId = exports.getCurrentCrossroadId = _ramda2.default.pipe(getCurrentCrossroad, _ramda2.default.propOr(null, 'id'));

var getCurrentCrossroadStep = exports.getCurrentCrossroadStep = _ramda2.default.pipe(getCurrentCrossroad, _crossroad.currentStep);
